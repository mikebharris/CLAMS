...
data "aws_s3_bucket" "attendees_api_lambda_function_distribution_bucket" {
...
resource "aws_lambda_function" "attendees_api_lambda_function" {
  ...
  handler          = "main"
  runtime          = "go1.x"
  s3_bucket        = data.aws_s3_bucket.attendees_api_lambda_function_distribution_bucket.bucket
